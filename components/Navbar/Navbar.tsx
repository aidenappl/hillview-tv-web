...
const Navbar = (props: NavbarProps) => {
	...
	return (
		<div className="w-screen h-[100px] z-20 shrink-0 border-b-2 border-neutral-100">
			<div className="relative w-full px-5 sm:px-0 sm:w-11/12 sm:max-w-screen-2xl sm:mx-auto flex items-center justify-between h-full">
				<Link href="/">
					<a>
												...
												>
													<a>
														<div className="group cursor-pointer search-res flex h-[80px] hover:bg-neutral-50 items-center">
															<div className={'thumbnail w-[90px] h-[55px] ml-5 rounded-md  overflow-hidden'}>
																<Image src={i.thumbnail} alt="Thumbnail" width={90} height={55}/>
															</div>

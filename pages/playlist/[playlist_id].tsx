						...
						<div className="center-object pb-20 items-center">
                            ...
                            <Link href={'/playlists'}>
                                <a className="full-x-center absolute mt-8">
                                    <button className='w-[130px] h-[40px] bg-primary-100 rounded-md text-white font-normal'>Go Back</button>
                                </a>
                            </Link>
						</div>
					</div>
...
export const getServerSideProps: GetServerSideProps = async (context: any) => {
    try {
        ...
        const response = await fetch(`https://api.hillview.tv/video/v1.1//read/playlist?route=${route}`);
